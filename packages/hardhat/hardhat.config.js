...
const _mnemonic = require('dotenv').config( { path: './../../../mnemonic.txt' } )
...
function mnemonic() {
  try {
    return  _mnemonic['parsed']['MNEMONIC'] //fs.readFileSync("./../../mnemonic.txt").toString().trim();
  } catch (e) {
...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      url: dotenv['parsed']['ETHEREUM_RINKEBY_ALCHEMY_HTTP'], // <---- YOUR INFURA ID! (or it won't work)
